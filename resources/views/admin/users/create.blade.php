...
<div class="mb-8">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="{{ route('admin.users.index') }}" class="px-5 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 flex items-center transition-colors duration-200">
...
<div class="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-100">
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="relative">
                        <select id="roleType" name="roleType" required
                            ...
                            <option value="librarian" {{ old('roleType') == 'librarian' ? 'selected' : '' }}>Librarian</option>
                            <option value="member" {{ old('roleType') == 'member' ? 'selected' : '' }}>Member</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="px-8 py-6 bg-gray-50 border-t border-gray-100 text-right">
            <button type="submit" class="inline-flex justify-center py-4 px-8 border border-transparent shadow-sm text-base font-medium rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
