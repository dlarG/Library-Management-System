    ...
    <div class="flex items-center justify-between px-6 py-3">
        ...
        <div class="flex-1 max-w-md mx-4">
            <div class="relative">
                ...
                <input type="text" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Search books...">
            </div>
        </div>
