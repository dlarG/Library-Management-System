...
<head>
    ...
    <title>LibraLynx - Library Management System</title>
...
<body class="font-sans antialiased text-gray-800 bg-gray-50">
    ...
    <nav x-data="{ open: false }" class="bg-white shadow-lg sticky top-0 z-50">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <a href="#" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Books</a>
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center">
                    <a href="{{ route('login') }}" class="px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Sign In</a>
                </div>
                <div class="-mr-2 flex items-center sm:hidden">
                    <button @click="open = !open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                        <svg class="h-6 w-6" x-bind:class="{ 'hidden': open, 'block': !open }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Mobile menu -->
        <div x-show="open" class="sm:hidden" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <a href="#" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Books</a>
                ...
                <div class="pt-4 pb-3 border-t border-gray-200">
                    <div class="mt-3 space-y-1">
                        <a href="{{ route('login') }}" class="block w-full px-4 py-2 text-base font-medium text-center text-white bg-indigo-600 hover:bg-indigo-700 rounded-md">Sign In</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="relative bg-indigo-800 overflow-hidden">
        <div class="max-w-7xl mx-auto">
            <div class="relative z-10 pb-8 bg-indigo-800 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                <svg class="hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-indigo-800 transform translate-x-1/2" fill="currentColor" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
                    <polygon points="50,0 100,0 50,100 0,100"></polygon>
                </svg>

                <div class="relative pt-10 px-4 sm:px-6 lg:px-8">
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                            ...
                            <span class="block text-indigo-200">Great Read</span>
                        </h1>
                        <p class="mt-3 text-base text-indigo-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            LibraLynx connects you with thousands of books from our digital library. Browse, borrow, and read anytime, anywhere.
                        </p>
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="Library bookshelf">
        </div>
    </div>
            ...
            <div class="mt-10">
                ...
                <div class="mt-8">
                    <div class="relative overflow-hidden">
                        ...
                        <button id="nextBtn" class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md z-10 mr-2 focus:outline-none">
                            <svg class="h-6 w-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                ...
                <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                    LibraLynx provides all the tools you need for modern library management.
                </p>
            </div>
            ...
            <div class="mt-10">
                <div class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="relative">
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Digital Catalog</p>
                        <p class="mt-2 ml-16 text-base text-gray-500">
                            Access our entire collection online with detailed information about each book, including reviews and recommendations.
                        </p>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Easy Reservations</p>
                        <p class="mt-2 ml-16 text-base text-gray-500">
                            Reserve books online and get notified when they're available. No more waiting in line!
                        </p>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <p class="mt-2 ml-16 text-base text-gray-500">
                            Get reminders for due dates, hold pickups, and new arrivals tailored to your interests.
                        </p>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Secure System</p>
                        <p class="mt-2 ml-16 text-base text-gray-500">
